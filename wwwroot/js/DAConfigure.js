...
function prepareLists() {
    list('engines', '/designautomation/engines');
...
async function deleteAppBundle( appBundleName ) {
    ...
    $.ajax({
        url: '/designautomation/appbundles/' + encodeURIComponent(appBundleName),
        type: "delete",
        dataType: "json",
...
async function deleteActivity( activityName) {
    ...
    $.ajax({
        url: '/designautomation/activities/' + encodeURIComponent(activityName),
        type: "delete",
        dataType: "json",
        success: function (res) {
            def.resolve(res);
...
function createAppBundle(fileName) {
    ...
    jQuery.ajax({
        url: '/designautomation/appbundles',
        method: 'POST',
...
function createActivity(fileName) {
    ...
    jQuery.ajax({
        url: '/designautomation/activities',
        method: 'POST',
        contentType: 'application/json',
        dataType: 'json',
        data: JSON.stringify({
